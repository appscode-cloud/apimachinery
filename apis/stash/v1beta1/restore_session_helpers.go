...
// UsesDeprecatedField check whether the RestoreSession uses any deprecated filed or not.
func (r *RestoreSession) UsesDeprecatedField() bool {
	return len(r.Spec.Rules) > 0
}
